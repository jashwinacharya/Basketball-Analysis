#Data has been taken from www.superdatascience.com
...
#Analyzing the basketball data exclding free throws data
...
myplot(FieldGoals/FieldGoalAttempes)
myplot(FieldGoalAttempts/Games)
myplot(Points/Games)

#Time played for each player per season
myplot(MinutesPlayed/Games)
myplot(Games)

#Average baskets scored
myplot(FieldGoals/MinutesPlayed)

#How many 2's and 3's pointer a player has scored (also including free throws)
myplot(Points/FieldGoals)

#-------------------------------------------------------------------------------------------

#Including Free Throws 
myplot(FreeThrowAttempts/Games)               #Plot 1
title(main="Free Throw Attempts per game")

myplot(FreeThrows/FreeThrowAttempts)                 #Plot 2
title(main="Free Throws Accuracy")

PlayingStyle <- (Points - FreeThrows)/FieldGoals    #This gives an average of the points a player got for their field goals
myplot(PlayingStyle)                          #Plot 3
title(main="Play Style of every Player")
